...
public class FileUtils {
	...
	public static String getLocator(String Locator) {
		...
		String LocatorValue = "";
		try {
			FileInputStream fis = new FileInputStream(basedir + "\\src\\main\\resources\\ashtvivah.properties");
	...
	public static String getappurl(String env) {
		...
		try {
			fis= new FileInputStream(basedir+"\\src\\main\\resources\\swiggy.properties");
			prop= new Properties();
			prop.load(fis);
